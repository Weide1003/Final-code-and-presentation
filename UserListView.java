...
public class UserListView extends JFrame {
    ...
    public UserListView() {
        ...
        Object[] columns = { "id","FirstName", "SecondName", "State", "City", "Street","PhoneNumber", "ZipCode","Salary","WorkSchedule"};
        ...
        deleteBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int result = JOptionPane.showConfirmDialog(contentPane, "Are you sure to delete this member?", "System prompt",
                ...
                if (result == 0) {
                    ...
                    if(flag){
                        JOptionPane.showMessageDialog(contentPane, "Successfully delete");
                        load(null);
                    }else{
