...
//            };
    ...
    public boolean save(Member member){
        ...
        Connection con = null;
        String sql = "insert into t_member(FirstName,SecondName,Name,City,Street,PhoneNumber,ZipCode,Salary,WorkSchedule,State) values(?,?,?,?,?,?,?,?,?,?)";
        PreparedStatement pstmt = null;
        try {
            con = JDBCUtils.getConnection();
...
//            pstmt.setTimestamp(5, new Timestamp(date.getTime()));
    ...
    public boolean update(Member member){
        ...
        Connection con = null;
        String sql = "update t_member set FirstName = ?,SecondName = ?,City = ?,Street = ?,PhoneNumber = ?,ZipCode = ?,Salary = ?,WorkSchedule = ?,State = ?,Name = ? where id=?";
        PreparedStatement pstmt = null;
        try {
            con = JDBCUtils.getConnection();
            pstmt = con.prepareStatement(sql);
