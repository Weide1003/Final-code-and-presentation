        ...
        saveBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(firstNameText == null || "".equals(secondNameText)){
                    JOptionPane.showMessageDialog(contentPane, "Please enter your firstName", "System prompt", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                if(secondNameText == null || "".equals(secondNameText)){
                    JOptionPane.showMessageDialog(contentPane, "Please enter your lastName", "System prompt", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                if(phoneNumber == null || "".equals(phoneNumber) || phoneNumber.length() != 11 ){
                    JOptionPane.showMessageDialog(contentPane, "Incorrect PhoneNumber", "System prompt", JOptionPane.WARNING_MESSAGE);
                    return;
                }
               // int i = 0;
                try{
                ...
                if(workSchedule == null || "".equals(workSchedule)){
                    JOptionPane.showMessageDialog(contentPane, "Please enter your WorkSchedule", "System prompt", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                if(flag){
                    ...
                    JOptionPane.showMessageDialog(contentPane, "Failure of operation", "System prompt", JOptionPane.WARNING_MESSAGE);
                }
                return;
